...
SPEC = json.loads(r'''{"_comment": "scripts/build_previz.py 가 만든다. 손으로 고치지 말고 블렌더에서 고친 뒤 그 값을 여기 적거나, shots_v2.json 을 고치고 다시 돌린다.", "화": "D01", "fps": 30, "해상도": [1080, 1920], "비율": "9:16", "총_프레임": 900, "총_초": 30.0, "컷_수": 7, "장면": {"SH": "쇼츠 · 쿵쿵이의 오늘 한마디 · 1화"}, "환경": {"SH": "개울"}, "컷": [{"id": "D01-01", "section": "SH", "샷": "CU", "샷_ko": "클로즈업", "초": 4, "시작_프레임": 1, "끝_프레임": 120, "연결": "전환", "화자": "", "대사": "", "설명": "쿵쿵이가 화면 아래에서 쏙 올라와 정면을 본다. 배경은 단순한 한 색이다.", "움직임_설명": "아기 공룡이 프레임 아래에서 위로 올라와 카메라를 본다.", "인물": [{"이름": "쿵쿵", "키_m": 1.4, "위치": [0.0, 0.0, 0.0], "방향_deg": 0.0, "말한다": true}], "카메라": {"렌즈_mm": 85, "거리_m": 1.16, "타깃": [0.0, 0.0, 1.26], "움직임": "상승", "밀림": 1.35, "시작": {"위치": [0.0, -1.218, 0.58], "회전_deg": [119.174, 0.0, 0.0]}, "끝": {"위치": [0.0, -1.16, 1.288], "회전_deg": [88.617, 0.0, 0.0]}}, "움직임_후보": ["상승"]}, {"id": "D01-02", "section": "SH", "샷": "MS", "샷_ko": "미디엄샷", "초": 4, "시작_프레임": 121, "끝_프레임": 240, "연결": "전환", "화자": "", "대사": "", "설명": "루비가 물가에서 별 지팡이를 흔들며 놀고 있다. 발밑의 무른 흙에 금이 가기 시작한다.", "움직임_설명": "루비가 지팡이를 흔들고 발밑 흙에 실금이 번져 나간다.", "인물": [{"이름": "루비", "키_m": 1.2, "위치": [0.0, 0.0, 0.0], "방향_deg": 0.0, "말한다": true}], "카메라": {"렌즈_mm": 50, "거리_m": 1.395, "타깃": [0.0, 0.0, 0.864], "움직임": "정지", "밀림": 1.35, "시작": {"위치": [0.0, -1.416, 1.02], "회전_deg": [83.713, 0.0, 0.0]}, "끝": {"위치": [0.0, -1.395, 1.02], "회전_deg": [83.619, 0.0, 0.0]}}, "움직임_후보": []}, {"id": "D01-03", "section": "SH", "샷": "MS", "샷_ko": "미디엄샷", "초": 4, "시작_프레임": 241, "끝_프레임": 360, "연결": "컷", "화자": "", "대사": "", "설명": "둑이 무너지고 루비가 거센 흙탕 급류에 휩쓸려 떠내려간다. 둑 위 친구들이 얼어붙는다.", "움직임_설명": "흙이 무너지며 루비가 물에 빠져 떠내려가고 친구들이 그 자리에 굳는다.", "인물": [{"이름": "루비", "키_m": 1.2, "위치": [-0.384, 0.18, 0.0], "방향_deg": 12.0, "말한다": false}, {"이름": "루카", "키_m": 1.6, "위치": [0.275, 0.979, 0.0], "방향_deg": 0.0, "말한다": true}, {"이름": "티니", "키_m": 1.1, "위치": [0.384, 0.18, 0.0], "방향_deg": -12.0, "말한다": false}], "카메라": {"렌즈_mm": 50, "거리_m": 3.753, "타깃": [0.0, 0.446, 1.152], "움직임": "정지", "밀림": 2.72, "시작": {"위치": [0.0, -3.363, 1.36], "회전_deg": [86.874, 0.0, 0.0]}, "끝": {"위치": [0.0, -3.307, 1.36], "회전_deg": [86.828, 0.0, 0.0]}}, "움직임_후보": []}, {"id": "D01-04", "section": "SH", "샷": "MS", "샷_ko": "미디엄샷", "초": 4, "시작_프레임": 361, "끝_프레임": 480, "연결": "컷", "화자": "", "대사": "", "설명": "쿵쿵이가 서툰 다리로 둑을 달려 물가에서 미끄러지듯 멈추며 두 앞발을 내리찍는다.", "움직임_설명": "아기 공룡이 달려와 미끄러지며 멈추고 앞발로 땅을 강하게 찍는다.", "인물": [{"이름": "쿵쿵", "키_m": 1.4, "위치": [0.0, 0.0, 0.0], "방향_deg": 0.0, "말한다": true}], "카메라": {"렌즈_mm": 50, "거리_m": 1.628, "타깃": [0.0, 0.0, 1.008], "움직임": "정지", "밀림": 1.35, "시작": {"위치": [0.0, -1.652, 1.19], "회전_deg": [83.713, 0.0, 0.0]}, "끝": {"위치": [0.0, -1.628, 1.19], "회전_deg": [83.621, 0.0, 0.0]}}, "움직임_후보": []}, {"id": "D01-05", "section": "SH", "샷": "WS", "샷_ko": "풀샷", "초": 5, "시작_프레임": 481, "끝_프레임": 630, "연결": "컷", "화자": "", "대사": "", "설명": "빛의 고리가 통나무를 밀어 개울을 가로막고, 떠내려오던 루비가 그것을 붙잡는다.", "움직임_설명": "빛 고리가 통나무를 굴려 개울에 걸치고 루비가 두 앞발로 붙잡아 몸을 끌어 올린다.", "인물": [{"이름": "루비", "키_m": 1.2, "위치": [0.0, 0.0, 0.0], "방향_deg": 0.0, "말한다": true}], "카메라": {"렌즈_mm": 24, "거리_m": 3.24, "타깃": [0.0, 0.0, 0.66], "움직임": "정지", "밀림": 1.35, "시작": {"위치": [0.0, -3.289, 0.936], "회전_deg": [85.203, 0.0, 0.0]}, "끝": {"위치": [0.0, -3.24, 0.936], "회전_deg": [85.131, 0.0, 0.0]}}, "움직임_후보": []}, {"id": "D01-06", "section": "SH", "샷": "MS", "샷_ko": "미디엄샷", "초": 5, "시작_프레임": 631, "끝_프레임": 780, "연결": "전환", "화자": "쿵쿵", "대사": "내가 친구들을 지켜줄게, 쿵쿵!", "설명": "쿵쿵이가 정면을 보고 두 앞발을 허리에 얹은 시그니처 포즈를 취한다. 하단에 자막 자리를 비운다.", "움직임_설명": "아기 공룡이 자세를 잡고 가슴을 펴며 카메라를 향해 환하게 웃는다.", "인물": [{"이름": "쿵쿵", "키_m": 1.4, "위치": [0.0, 0.0, 0.0], "방향_deg": 0.0, "말한다": true}], "카메라": {"렌즈_mm": 50, "거리_m": 1.628, "타깃": [0.0, 0.0, 1.008], "움직임": "정지", "밀림": 1.35, "시작": {"위치": [0.0, -1.652, 1.19], "회전_deg": [83.713, 0.0, 0.0]}, "끝": {"위치": [0.0, -1.628, 1.19], "회전_deg": [83.621, 0.0, 0.0]}}, "움직임_후보": []}, {"id": "D01-07", "section": "SH", "샷": "타이틀", "샷_ko": "타이틀", "초": 4, "시작_프레임": 781, "끝_프레임": 900, "연결": "컷", "화자": "", "대사": "", "설명": "엔드 카드. 쿵쿵이가 손을 흔든다. 하단에 채널 이름을 넣을 여백.", "움직임_설명": "아기 공룡이 앞발을 흔들고 화면이 아주 느리게 물러난다.", "인물": [{"이름": "쿵쿵", "키_m": 1.4, "위치": [0.0, 0.0, 0.0], "방향_deg": 0.0, "말한다": true}], "카메라": {"렌즈_mm": 35, "거리_m": 4.043, "타깃": [0.0, 0.0, 0.84], "움직임": "후진", "밀림": 1.35, "시작": {"위치": [0.0, -4.043, 1.12], "회전_deg": [86.038, 0.0, 0.0]}, "끝": {"위치": [0.0, -5.255, 1.12], "회전_deg": [86.95, 0.0, 0.0]}}, "움직임_후보": ["후진"]}], "키": {"쿵쿵": 1.4, "루카": 1.6, "후안": 1.0, "미미": 1.05, "티니": 1.1, "루비": 1.2, "노을": 1.3}, "색": {"쿵쿵": [0.55, 0.85, 0.7], "루카": [0.55, 0.65, 0.9], "후안": [0.95, 0.75, 0.45], "미미": [0.9, 0.6, 0.8], "티니": [0.95, 0.9, 0.5], "루비": [0.95, 0.65, 0.72], "노을": [0.95, 0.55, 0.35]}}''')
FLOOR = json.loads(r'''{"개울": [0.44, 0.5, 0.4], "기본": [0.5, 0.5, 0.5]}''')
