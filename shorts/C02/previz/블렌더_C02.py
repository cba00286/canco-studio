...
SPEC = json.loads(r'''{"_comment": "scripts/build_previz.py 가 만든다. 손으로 고치지 말고 블렌더에서 고친 뒤 그 값을 여기 적거나, shots_v2.json 을 고치고 다시 돌린다.", "화": "C02", "fps": 30, "해상도": [1080, 1920], "비율": "9:16", "총_프레임": 690, "총_초": 23.0, "컷_수": 5, "장면": {"SH": "쇼츠 · 루카는 이런 아이야"}, "환경": {"SH": "실내_집"}, "컷": [{"id": "C02-01", "section": "SH", "샷": "CU", "샷_ko": "클로즈업", "초": 4, "시작_프레임": 1, "끝_프레임": 120, "연결": "전환", "화자": "", "대사": "", "설명": "루카 얼굴 클로즈업. 화면 아래에서 쏙 올라와 정면을 본다. 눈이 장난기로 반짝인다.", "움직임_설명": "루카가 프레임 아래에서 위로 쏙 올라와 카메라를 정면으로 본다.", "인물": [{"이름": "루카", "키_m": 1.6, "위치": [0.0, 0.0, 0.0], "방향_deg": 0.0, "말한다": true}], "카메라": {"렌즈_mm": 85, "거리_m": 1.326, "타깃": [0.0, 0.0, 1.44], "움직임": "상승", "밀림": 1.35, "시작": {"위치": [0.0, -1.392, 0.662], "회전_deg": [119.201, 0.0, 0.0]}, "끝": {"위치": [0.0, -1.326, 1.472], "회전_deg": [88.618, 0.0, 0.0]}}, "움직임_후보": ["상승"]}, {"id": "C02-02", "section": "SH", "샷": "MS", "샷_ko": "미디엄샷", "초": 4, "시작_프레임": 121, "끝_프레임": 240, "연결": "연속", "화자": "", "대사": "", "설명": "루카가 오버올 앞주머니에서 비행 고글을 꺼내 눈에 척 쓰고, 다른 손으로 낡은 지도를 펼쳐 든다.", "움직임_설명": "호랑이가 고글을 눈에 딱 맞춰 쓰고, 손에 든 지도를 좌악 펼친다.", "인물": [{"이름": "루카", "키_m": 1.6, "위치": [0.0, 0.0, 0.0], "방향_deg": 0.0, "말한다": true}], "카메라": {"렌즈_mm": 50, "거리_m": 1.86, "타깃": [0.0, 0.0, 1.152], "움직임": "정지", "밀림": 1.35, "시작": {"위치": [0.0, -1.888, 1.36], "회전_deg": [83.713, 0.0, 0.0]}, "끝": {"위치": [0.0, -1.86, 1.36], "회전_deg": [83.619, 0.0, 0.0]}}, "움직임_후보": []}, {"id": "C02-03", "section": "SH", "샷": "MS", "샷_ko": "미디엄샷", "초": 5, "시작_프레임": 241, "끝_프레임": 390, "연결": "컷", "화자": "", "대사": "", "설명": "루카가 앞장서 걷고 넷이 그 뒤를 따른다. 루카가 팔을 옆으로 뻗어 뒤를 막았다가 앞을 가리킨다.", "움직임_설명": "루카가 팔을 뻗어 뒤를 막았다가 앞을 가리키고 넷이 따라 움직인다.", "인물": [{"이름": "티니", "키_m": 1.1, "위치": [-0.807, 0.18, 0.0], "방향_deg": 12.0, "말한다": false}, {"이름": "후안", "키_m": 1.0, "위치": [-0.143, 0.882, 0.0], "방향_deg": 12.0, "말한다": false}, {"이름": "쿵쿵", "키_m": 1.4, "위치": [0.006, 0.001, 0.0], "방향_deg": 0.0, "말한다": true}, {"이름": "루카", "키_m": 1.6, "위치": [0.693, 1.004, 0.0], "방향_deg": -12.0, "말한다": false}, {"이름": "미미", "키_m": 1.05, "위치": [0.807, 0.18, 0.0], "방향_deg": -12.0, "말한다": false}], "카메라": {"렌즈_mm": 50, "거리_m": 6.364, "타깃": [0.0, 0.449, 1.008], "움직임": "정지", "밀림": 5.28, "시작": {"위치": [0.0, -6.01, 1.19], "회전_deg": [88.386, 0.0, 0.0]}, "끝": {"위치": [0.0, -5.915, 1.19], "회전_deg": [88.362, 0.0, 0.0]}}, "움직임_후보": []}, {"id": "C02-04", "section": "SH", "샷": "WS", "샷_ko": "풀샷", "초": 5, "시작_프레임": 391, "끝_프레임": 540, "연결": "컷", "화자": "", "대사": "", "설명": "큰 나무를 감아 올라간 2층 나무집 앞. 꼭대기에 전망대와 망원경이 보이고 사다리가 여러 갈래로 나 있다.", "움직임_설명": "루카가 자기 집 앞에 서서 두 팔을 벌리고 집을 소개하듯 몸을 돌린다.", "인물": [{"이름": "루카", "키_m": 1.6, "위치": [0.0, 0.0, 0.0], "방향_deg": 0.0, "말한다": true}], "카메라": {"렌즈_mm": 24, "거리_m": 4.32, "타깃": [0.0, 0.0, 0.88], "움직임": "정지", "밀림": 1.35, "시작": {"위치": [0.0, -4.385, 1.248], "회전_deg": [85.203, 0.0, 0.0]}, "끝": {"위치": [0.0, -4.32, 1.248], "회전_deg": [85.131, 0.0, 0.0]}}, "움직임_후보": []}, {"id": "C02-05", "section": "SH", "샷": "MS", "샷_ko": "미디엄샷", "초": 5, "시작_프레임": 541, "끝_프레임": 690, "연결": "컷", "화자": "루카", "대사": "가자! 아무도 안 가본 데로!", "설명": "루카가 정면을 보고 시그니처 자세를 취한다. 배경은 단순하게 비우고, 아래쪽에 이름을 넣을 여백을 둔다.", "움직임_설명": "루카가 자세를 잡고 카메라를 향해 웃으며, 아래쪽 여백이 그대로 남는다.", "인물": [{"이름": "루카", "키_m": 1.6, "위치": [0.0, 0.0, 0.0], "방향_deg": 0.0, "말한다": true}], "카메라": {"렌즈_mm": 50, "거리_m": 1.86, "타깃": [0.0, 0.0, 1.152], "움직임": "정지", "밀림": 1.35, "시작": {"위치": [0.0, -1.888, 1.36], "회전_deg": [83.713, 0.0, 0.0]}, "끝": {"위치": [0.0, -1.86, 1.36], "회전_deg": [83.619, 0.0, 0.0]}}, "움직임_후보": []}], "키": {"쿵쿵": 1.4, "루카": 1.6, "후안": 1.0, "미미": 1.05, "티니": 1.1, "루비": 1.2, "노을": 1.3}, "색": {"쿵쿵": [0.55, 0.85, 0.7], "루카": [0.55, 0.65, 0.9], "후안": [0.95, 0.75, 0.45], "미미": [0.9, 0.6, 0.8], "티니": [0.95, 0.9, 0.5], "루비": [0.95, 0.65, 0.72], "노을": [0.95, 0.55, 0.35]}}''')
