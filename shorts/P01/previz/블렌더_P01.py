...
SPEC = json.loads(r'''{"_comment": "scripts/build_previz.py 가 만든다. 손으로 고치지 말고 블렌더에서 고친 뒤 그 값을 여기 적거나, shots_v2.json 을 고치고 다시 돌린다.", "화": "P01", "fps": 30, "해상도": [1080, 1920], "비율": "9:16", "총_프레임": 690, "총_초": 23.0, "컷_수": 5, "장면": {"SH": "쇼츠 · 쿵! 하고 땅이 울리면"}, "환경": {"SH": "숲_낮"}, "컷": [{"id": "P01-01", "section": "SH", "샷": "CU", "샷_ko": "클로즈업", "초": 4, "시작_프레임": 1, "끝_프레임": 120, "연결": "전환", "화자": "", "대사": "", "설명": "쿵쿵이 얼굴 클로즈업. 눈에 힘이 들어가고 입을 야무지게 다문다.", "움직임_설명": "아기 공룡이 턱을 당기며 결심한 표정을 짓는다.", "인물": [{"이름": "쿵쿵", "키_m": 1.4, "위치": [0.0, 0.0, 0.0], "방향_deg": 0.0, "말한다": true}], "카메라": {"렌즈_mm": 85, "거리_m": 1.16, "타깃": [0.0, 0.0, 1.26], "움직임": "정지", "밀림": 1.35, "시작": {"위치": [0.0, -1.178, 1.288], "회전_deg": [88.638, 0.0, 0.0]}, "끝": {"위치": [0.0, -1.16, 1.288], "회전_deg": [88.617, 0.0, 0.0]}}, "움직임_후보": []}, {"id": "P01-02", "section": "SH", "샷": "MS", "샷_ko": "미디엄샷", "초": 4, "시작_프레임": 121, "끝_프레임": 240, "연결": "연속", "화자": "", "대사": "", "설명": "쿵쿵이가 몸을 뒤로 젖히며 두 앞발을 번쩍 들어 올린다.", "움직임_설명": "아기 공룡이 뒷다리에 힘을 주고 앞발을 최대한 높이 든다.", "인물": [{"이름": "쿵쿵", "키_m": 1.4, "위치": [0.0, 0.0, 0.0], "방향_deg": 0.0, "말한다": true}], "카메라": {"렌즈_mm": 50, "거리_m": 1.628, "타깃": [0.0, 0.0, 1.008], "움직임": "정지", "밀림": 1.35, "시작": {"위치": [0.0, -1.652, 1.19], "회전_deg": [83.713, 0.0, 0.0]}, "끝": {"위치": [0.0, -1.628, 1.19], "회전_deg": [83.621, 0.0, 0.0]}}, "움직임_후보": []}, {"id": "P01-03", "section": "SH", "샷": "WS", "샷_ko": "풀샷", "초": 5, "시작_프레임": 241, "끝_프레임": 390, "연결": "연속", "화자": "", "대사": "", "설명": "쿵! 앞발이 땅을 내리찍고, 뿔을 따라 금빛 청록 빛이 흐르며 발밑에서 충격파 고리가 퍼진다.", "움직임_설명": "앞발이 땅을 강타하고 빛이 뿔을 타고 오르며 빛 고리가 사방으로 번져 나간다.", "인물": [{"이름": "쿵쿵", "키_m": 1.4, "위치": [0.0, 0.0, 0.0], "방향_deg": 0.0, "말한다": true}], "카메라": {"렌즈_mm": 24, "거리_m": 3.78, "타깃": [0.0, 0.0, 0.77], "움직임": "정지", "밀림": 1.35, "시작": {"위치": [0.0, -3.837, 1.092], "회전_deg": [85.203, 0.0, 0.0]}, "끝": {"위치": [0.0, -3.78, 1.092], "회전_deg": [85.131, 0.0, 0.0]}}, "움직임_후보": []}, {"id": "P01-04", "section": "SH", "샷": "WS", "샷_ko": "풀샷", "초": 5, "시작_프레임": 391, "끝_프레임": 540, "연결": "연속", "화자": "", "대사": "", "설명": "빛 고리가 지나간 자리의 잔돌들이 스스로 굴러 모여 계단처럼 차곡차곡 쌓인다.", "움직임_설명": "돌들이 진동하며 한곳으로 굴러 모이고 층층이 쌓여 계단 모양이 된다.", "인물": [], "카메라": {"렌즈_mm": 24, "거리_m": 4.32, "타깃": [0.0, 0.0, 0.88], "움직임": "정지", "밀림": 1.35, "시작": {"위치": [0.0, -4.385, 1.248], "회전_deg": [85.203, 0.0, 0.0]}, "끝": {"위치": [0.0, -4.32, 1.248], "회전_deg": [85.131, 0.0, 0.0]}}, "움직임_후보": []}, {"id": "P01-05", "section": "SH", "샷": "MS", "샷_ko": "미디엄샷", "초": 5, "시작_프레임": 541, "끝_프레임": 690, "연결": "컷", "화자": "쿵쿵", "대사": "헤헤, 내가 지켜줄게. 쿵쿵!", "설명": "먼지가 가라앉고 쿵쿵이가 두 앞발을 허리에 얹은 시그니처 포즈를 취한다. 하단에 여백을 둔다.", "움직임_설명": "먼지가 내려앉는 사이 아기 공룡이 자세를 잡고 가슴을 편다.", "인물": [{"이름": "쿵쿵", "키_m": 1.4, "위치": [0.0, 0.0, 0.0], "방향_deg": 0.0, "말한다": true}], "카메라": {"렌즈_mm": 50, "거리_m": 1.628, "타깃": [0.0, 0.0, 1.008], "움직임": "정지", "밀림": 1.35, "시작": {"위치": [0.0, -1.652, 1.19], "회전_deg": [83.713, 0.0, 0.0]}, "끝": {"위치": [0.0, -1.628, 1.19], "회전_deg": [83.621, 0.0, 0.0]}}, "움직임_후보": []}], "키": {"쿵쿵": 1.4, "루카": 1.6, "후안": 1.0, "미미": 1.05, "티니": 1.1, "루비": 1.2, "노을": 1.3}, "색": {"쿵쿵": [0.55, 0.85, 0.7], "루카": [0.55, 0.65, 0.9], "후안": [0.95, 0.75, 0.45], "미미": [0.9, 0.6, 0.8], "티니": [0.95, 0.9, 0.5], "루비": [0.95, 0.65, 0.72], "노을": [0.95, 0.55, 0.35]}}''')
